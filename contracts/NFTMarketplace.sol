...
contract NFTMarketplace is ReentrancyGuard, Pausable, AccessControl {
     ...
     * @param newAmount New number of tokens to sell
     * @param newPrice New total price for the listing in payment tokens
     * @param newPrivateBuyer New private buyer address
     */
    ...
    /**
     * @notice Batch update existing listings with private buyers
     */
    function batchUpdateListingsWithPrivateBuyers(address[] calldata nftContracts, uint256[] calldata tokenIds, uint256[] calldata newAmounts, uint256[] calldata newPrices, address[] calldata newPrivateBuyers) external whenNotPaused {
