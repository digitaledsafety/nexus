...
contract NFTMarketplace is ReentrancyGuard, Pausable, AccessControl {
    ...
    /**
     * @notice Update an existing listing with optional private buyer
     * @param nftContract Address of the NFT contract
     * @param tokenId ID of the token being listed
     * @param newAmount New number of tokens to sell
     * @param newPrice New total price for the listing in payment tokens
     * @param privateBuyer The new target private buyer (or address(0) to remove restriction)
     */
    ...
    /**
     * @notice Batch update multiple existing private listings with new target buyers
     */
