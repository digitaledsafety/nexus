...
contract ExhibitVault is ERC721Holder, ERC1155Holder, ReentrancyGuard, AccessControl {
    ...
    /**
     * @dev Move multiple ERC721 tokens directly to another verified vault with exhibition duration.
     */
    ...
    /**
     * @dev Move multiple ERC1155 tokens directly to another verified vault with exhibition duration.
     */
