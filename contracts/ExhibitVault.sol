...
contract ExhibitVault is ERC721Holder, ERC1155Holder, ReentrancyGuard, AccessControl {
    ...
    /**
     * @dev Move multiple ERC721 tokens directly to another verified vault with custom time-locks.
     */
    ...
    /**
     * @dev Move multiple ERC1155 tokens directly to another verified vault with custom time-locks.
     */
    ...
    /**
     * @dev Extend exhibition duration for multiple ERC721 tokens.
     */
    ...
    /**
     * @dev Extend exhibition duration for multiple ERC1155 tokens.
     */
