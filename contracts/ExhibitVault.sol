...
contract ExhibitVault is ERC721Holder, ERC1155Holder, ReentrancyGuard, AccessControl {
    ...
    /**
     * @notice Batch exhibit multiple ERC721 tokens
     */
    ...
    /**
     * @notice Batch exhibit multiple ERC1155 tokens
     */
    function batchExhibit1155(address[] calldata nftContracts, uint256[] calldata ids, uint256[] calldata amounts, uint256 duration) external nonReentrant {
    ...
    function extendExhibition721(address nftContract, uint256 tokenId, uint256 additionalDuration) external nonReentrant {
        ...
        emit Exhibited721(nftContract, tokenId, msg.sender, registry.getVaultInfo(address(this)).name, expiry721[nftContract][tokenId]);
    }
    ...
    function extendExhibition1155(address nftContract, uint256 tokenId, uint256 additionalDuration) external nonReentrant {
        ...
        emit Exhibited1155(nftContract, tokenId, msg.sender, balances1155[nftContract][tokenId][msg.sender], registry.getVaultInfo(address(this)).name, expiry1155[nftContract][tokenId][msg.sender]);
    }
