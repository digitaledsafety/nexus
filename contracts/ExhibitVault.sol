...
contract ExhibitVault is ERC721Holder, ERC1155Holder, ReentrancyGuard, AccessControl {
    ...
    function moveBatch721(address nftContract, uint256[] calldata tokenIds, address destinationVault) external nonReentrant {
        _moveBatch721(nftContract, tokenIds, destinationVault, 0);
    }

    function moveBatch721WithDuration(address nftContract, uint256[] calldata tokenIds, address destinationVault, uint256 duration) public nonReentrant {
        _moveBatch721(nftContract, tokenIds, destinationVault, duration);
    }

    function _moveBatch721(address nftContract, uint256[] calldata tokenIds, address destinationVault, uint256 duration) internal {
